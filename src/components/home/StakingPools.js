    ...
    <Container maxWidth={'xl'}>
      ...
      <Grid container spacing={3} mt={4}>
        <Grid item md={3} xs={12} sm={6} minHeight={'100%'}>
          <Box
            sx={{
              background: 'linear-gradient(0deg, rgba(40, 140, 197, 0.15) 49.84%, rgba(93, 213, 230, 0.15) 100.31%)',
          ...
          >
            ...
            <Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}>04%</Typography>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Lock-up term</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}>7 days</Typography>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Pool Participants</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}> -- </Typography>
              </Box>
            </Box>
        ...
        <Grid item md={3} sm={6} xs={12} minHeight={'100%'}>
          ...
          >
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Lock-up term</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}> 30 days</Typography>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Pool Participants</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}> -- </Typography>
        ...
        <Grid item md={3} sm={6} xs={12} minHeight={'100%'}>
          <Box
            sx={{
              background: 'linear-gradient(0deg, rgba(40, 140, 197, 0.5) 49.84%, rgba(93, 213, 230, 0.5) 100.31%);',
              boxShadow: '0px 1px 9px rgba(0, 0, 0, 0.34)',
              borderRadius: '20px',
              padding: '30px',
              display: 'flex',
          ...
          >
            ...
            <Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Fixed APR</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}>08%</Typography>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Lock-up term</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}> 90 days</Typography>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Pool Participants</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}> -- </Typography>
        ...
        <Grid item md={3} sm={6} xs={12} minHeight={'100%'}>
          ...
          >
            ...
            <Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Fixed APR</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}>15%</Typography>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Lock-up term</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}> 180 days</Typography>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff' }}> Pool Participants</Typography>
                <Typography sx={{ fontSize: '1rem', color: '#ffffff', fontWeight: 700 }}> -- </Typography>
