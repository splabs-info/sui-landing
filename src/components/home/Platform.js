...
import { PlatformBox, TitleBox, TypographyGradient } from './HomeStyles';
        ...
        <Box pt={isDesktop ? 10 : 3} pb={isDesktop ? 5 : 3}>
            <Container>
                <TitleBox>
                    ...
                    <Box
                        component={'h3'}
                        sx={{ color: 'white', marginBottom: '2rem', textShadow: 'rgba(255,255,255,0.25) 0 0 4px' }}
                    >
                    ...
                    <Box component={'p'} sx={{ color: 'white', paddingBottom: isDesktop ? '4rem' : '1rem' }}>
                        Through analysis and reviews from many third parties, these products will be maximized to bring
                        the highest efficiency to everyone.
                    </Box>
                </TitleBox>
                ...
                <SliderCustom {...platformSliderSettings}>
                    {platforms.map((platform, index) => (
                        <PlatformBox key={index} sx={{ background: platform.background }}>
                            <img src={`./images/platform/step-${index + 1}.png`} alt={platform.label} />
                            <TypographyGradient
                                sx={{
                                    fontSize: '1.2rem',
                                    fontFamily: 'SVN-Gilroy-heavy',
