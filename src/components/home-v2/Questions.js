...
import { CenterBox, CustomTabList, CustomTabPanel, QuestionsButton, SectionBox, TextTypography } from './HomeStyles';
  ...
  return (
    ...
    >
      <Container maxWidth={'xl'} >
        ...
        <CenterBox my={5}>
          <Box sx={{ width: '100%' }} component={'img'} src="/images/whitepaper/Staking-Tier.jpg" alt="" borderRadius={2}/>
        </CenterBox>
      </Container>
    </SectionBox>
  );
