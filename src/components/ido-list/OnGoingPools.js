                        ...
                        <ProcessBarBox
                            ...
                            subtitle={
                                <>
                                    ...
                                    <Typography>{totalSold && totalSupply ? <>{`${ethers.utils.formatUnits(totalSold, 9)} / ${ethers.utils.formatUnits(totalSupply, 9)}`} XUI</> : 'Loading'} </Typography>
                                </>
                            }
