            ...
            >
                <Grid container alignItems={'center'} spacing={5}>
                    ...
                    <Grid item md={8} xs={12}>
                        ...
                        <Typography>
                            A is the easiest and fastest approach for developers who want to experime Web3, enabling the
                            best addition of blockchain features to their games in a few minutes for the future of
                            gaming…
                        </Typography>
                        <Box
                            sx={{
