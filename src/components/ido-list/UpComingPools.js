...
const dataReleap = {
    ...
    startTime: '2023-08-07T12:00:00Z',
    endTime: '2023-08-08T12:00:00Z',
    description: [
        <>
            <p></p>
            <p>70,000 USD</p>
...
export default function UpComingPools({ hasInTimeIDOXUI = false, round }) {
    const [list, setList] = React.useState([]);
    const now = moment();

    console.log('round__UpComingPools', round)
