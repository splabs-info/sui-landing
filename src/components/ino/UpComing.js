        ...
        <Grid container alignItems={'center'} spacing={5}>
          ...
          <Grid item md={7} xs={12}>
            ...
            <Stack spacing={1.5} alignItems={'center'} sx={{ marginTop: isMobile ? '24px' : '24px' }}>
              <BorderGradientButton onClick={() => navigate('/ino-launchpad/free-minting-nft')} sx={{}} disabled>
                JOIN NOW
        ...
        <Grid container alignItems={'center'} spacing={5}>
          ...
          <Grid item md={7} xs={12}>
            ...
            <Stack spacing={1.5} alignItems={'center'}>
              ...
              <BorderGradientButton disabled={true}>Official Launch : July 25th</BorderGradientButton>
            </Stack>
          </Grid>
        </Grid>
      </Box>
