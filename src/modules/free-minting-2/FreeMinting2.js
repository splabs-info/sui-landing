          ...
          <FreeMintingBox>
            <Grid container spacing={3}>
              <Grid item md={6} xs={12}>
                ...
                <MintingCountdown endTime={'2023-06-24T11:00:00'} _handleComplete={() => setHasInTimes(true)} />

                <Typography variant="body1" color={'#A0FFF4'} fontStyle={'italic'} mt={2}>
                  *** Claim schedule: 11:00 (UTC) 24th June, 2023
                </Typography>
                ...
                <GradientLoadingButton
                  ...
                  loading={loading}
                  disabled={!hasInTimes || owned > 0 || minted === total}
