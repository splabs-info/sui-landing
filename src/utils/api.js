...
async function myFetch(method, endpoint, body, successCallback, errorCallback) {
    ...
    try {
        switch (method) {
            case 'POST':
                response = await axiosWithCookies.post(url, body);
                break;
            case 'PUT':
                response = await axiosWithCookies.put(url, body);
                break;
            case 'DELETE':
                response = await axiosWithCookies.delete(url, body);
                break;
            default:
                response = await axiosWithCookies.get(url);
                break;
        }
        _handleSuccess(response, successCallback);
    } catch (error) {
